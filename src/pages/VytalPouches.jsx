...
import { Sparkles, ShieldCheck, Zap, Droplets, Activity, ArrowRight, CheckCircle2, Package, Info, AlertCircle, ShoppingBag } from 'lucide-react';
  ...
  const products = [
    {
      ...
      img: '/assets/pouches/vytal-energy.png',
      desc: 'Bright, clean energy oral pouch formulation designed for sustained cognitive focus and physical vitality without jitters.',
      ingredients: ['Natural Soursop Extract', 'Lime Zest Essence', 'Organic Green Tea Caffeine (50mg)', 'L-Theanine', 'Electrolyte Complex'],
      specs: '15 Pouches per Matte-Black Tin • Zero Tobacco • Zero Nicotine'
    },
    {
      id: 'tidal',
      name: 'VYTAL Tidal',
      tagline: 'FLOW & HYDRATION',
      ...
      img: '/assets/pouches/vytal-tidal.png',
      desc: 'Nourishing botanical blend combining wildcrafted sea moss, cooling cucumber, and crisp lime for cellular hydration support.',
      ingredients: ['Wildcrafted St. Lucia Sea Moss', 'Crisp Cucumber Extract', 'Key Lime Essence', 'Trace Mineral Blend', 'Magnesium Glycinate'],
      specs: '15 Pouches per Matte-Black Tin • Zero Tobacco • Zero Nicotine'
    },
    {
      id: 'nad-support',
      name: 'VYTAL NAD Support',
      tagline: 'CELLULAR BASELINE',
      flavor: 'Blue Soursop Yuzu',
      color: 'from-sky-500/20 to-blue-900/10',
      borderColor: 'border-sky-500/40',
      badgeColor: 'text-sky-400 bg-sky-950/40 border-sky-500/30',
      img: '/assets/pouches/vytal-nad-support.png',
      desc: 'Next-generation sublingual pouch delivering precursor nutrients and antioxidants designed to support mitochondrial stamina.',
      ingredients: ['Nicotinamide Riboside (NR)', 'Blue Soursop Extract', 'Japanese Yuzu Citrus', 'Resveratrol', 'Vitamin B-Complex'],
      specs: '15 Pouches per Matte-Black Tin • Zero Tobacco • Zero Nicotine'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-mono bg-amber-500/10 border border-amber-500/30 text-[#C5A059]">
                ...
                <PlaceholderBadge text="FOUNDERS PILOT" />
              </div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed font-light">
                Sublingual functional pouches engineered in three targeted formulations — <strong>VYTAL Energy</strong>, <strong>VYTAL Tidal</strong>, and <strong>VYTAL NAD Support</strong>. Delivered in sleek matte-black aluminum tins.
              </p>
            ...
            <div className="relative flex justify-center items-center">
              ...
              <div className="p-4 rounded-3xl bg-[#131A26]/80 border border-[#C5A059]/30 shadow-2xl backdrop-blur-sm group hover:border-[#C5A059]/60 transition-all duration-300">
                <img
                  src="/assets/pouches/vytal-trio.png"
                  alt="VYTAL Pouches Collection — Energy, Tidal, NAD Support"
                  className="w-full max-w-md h-auto object-contain transition transform group-hover:scale-105 duration-500"
                />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-heading font-bold text-sm text-white tracking-widest uppercase">
                THE VYTAL POUCH RITUAL SEQUENCE
              </span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full md:w-auto text-xs font-mono">
              <div className="p-3 rounded-xl bg-amber-950/30 border border-amber-500/20 flex items-center gap-3">
              ...
              <div className="p-3 rounded-xl bg-emerald-950/30 border border-emerald-500/20 flex items-center gap-3">
              ...
              <div className="p-3 rounded-xl bg-sky-950/30 border border-sky-500/20 flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-gray-400 text-sm">
              Each pouch is formulated with clean ingredients, natural botanical essences, and zero fillers. Designed for direct sublingual release.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {products.map((p) => (
              ...
              >
                ...
                {/* Product Image */}
                <div className="relative py-4 flex justify-center items-center bg-[#080B11]/60 rounded-xl border border-gray-800/80">
                  <img
                    src={p.img}
                    alt={p.name}
